...
| Contract          | Address                                                |
|-------------------|--------------------------------------------------------|
| Odyssey Package   | `0x8127c4334e6a2e8ed51a631334762866efddd7c42cb20f131df3fed8db7bd870` |
| Module            | `moonbags`                                             |
...
Example:
```
0x8127c4334e6a2e8ed51a631334762866efddd7c42cb20f131df3fed8db7bd870::moonbags::COIN_TEMPLATE
```
...
// Example: Create pool
tx.moveCall({
  target: '0x8127c4334e6a2e8ed51a631334762866efddd7c42cb20f131df3fed8db7bd870::moonbags::create_and_lock_first_buy_with_fee',
